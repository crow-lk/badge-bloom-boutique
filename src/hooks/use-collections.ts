...
export const fallbackCollections: Collection[] = [
  {
    ...
    name: "Atelier AW 24",
    slug: "atelier-aw-24",
    summary: "Sculpted silhouettes for monsoon evenings.",
    description:
      "Signature wool, silk, and linen layers tailored for the city. Each piece is hand-finished in small batches for a relaxed yet elevated drape.",
    heroImage: coatImage,
    coverImage: coatImage,
    lookbook: [coatImage, pantsImage, sweaterImage],
    productCount: 12,
    status: "Available",
    season: "Autumn/Winter 2024",
    tags: ["Limited run", "Studio edit"],
    highlights: ["Hand-finished tailoring", "Cloud-soft lining"],
    meta: [
      { label: "Season", value: "AW 24" },
      { label: "Release", value: "August 2024" },
    ],
    previewProducts: [
      { id: "wool-coat", name: "Wool Coat", image: coatImage, slug: "wool-coat", priceLabel: "Enquire for price" },
      {
        id: "linen-trousers",
        name: "Linen Trousers",
        image: pantsImage,
        slug: "linen-trousers",
        priceLabel: "LKR 89.00",
      },
    ],
  },
  {
    id: "resort-linen",
    name: "Resort Linen Story",
    slug: "resort-linen-story",
    summary: "Airy layers dyed with coastal hues.",
    description:
      "Featherlight linens and organic cottons washed for softness from day one. Designed to layer over swim or under a blazer when the sunset breeze rolls in.",
    heroImage: pantsImage,
    coverImage: pantsImage,
    lookbook: [pantsImage, tshirtImage, sweaterImage],
    productCount: 9,
    status: "Available",
    season: "Resort",
    tags: ["Travel ready", "Easy care"],
    highlights: ["Wrinkle-kissed finish", "Breathable linen blends"],
    meta: [
      { label: "Season", value: "Resort" },
      { label: "Color story", value: "Sea glass + clay" },
    ],
    previewProducts: [
      { id: "linen-trousers", name: "Linen Trousers", image: pantsImage, slug: "linen-trousers" },
      { id: "essential-tee", name: "Essential Tee", image: tshirtImage, slug: "essential-t-shirt" },
    ],
  },
  {
    id: "studio-lounge",
    name: "Studio Lounge Capsule",
    slug: "studio-lounge-capsule",
    summary: "Soft ribbing and fluid knits for inside days.",
    description:
      "Relaxed sweaters, elevated joggers, and draped tops knit from recycled yarns. Each silhouette is balanced to pair with tailoring when you head out.",
    heroImage: sweaterImage,
    coverImage: sweaterImage,
    lookbook: [sweaterImage, tshirtImage, coatImage],
    productCount: 7,
    status: "Limited",
    season: "All-season",
    tags: ["Studio knitwear", "Recycled fibers"],
    highlights: ["Second-skin softness", "Day-to-night ease"],
    meta: [
      { label: "Season", value: "All-season" },
      { label: "Status", value: "Limited" },
    ],
    previewProducts: [
      { id: "knit-sweater", name: "Knit Sweater", image: sweaterImage, slug: "knit-sweater" },
      { id: "essential-t-shirt", name: "Essential T-Shirt", image: tshirtImage, slug: "essential-t-shirt" },
    ],
  },
];
