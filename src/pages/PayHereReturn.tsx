...
const PayHereReturn = () => {
  ...
  const [storedCheckout] = useState(() => loadPayHereCheckout());
  ...
  const paymentStatusQuery = useQuery({
    queryKey: ["payhere-status", paymentId],
    queryFn: () => fetchPaymentStatus(paymentId as string | number),
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto max-w-3xl space-y-8 px-4 sm:px-6 lg:px-8">
          <div className="space-y-2 text-center">
            <p className="text-[11px] uppercase tracking-[0.35em] text-muted-foreground">PayHere</p>
            <h1 className="text-3xl font-light tracking-tight md:text-4xl">Processing your payment</h1>
            <p className="text-sm text-muted-foreground md:text-base">
              We&apos;re confirming your transaction and creating your order.
            </p>
          </div>
            ...
            {!storedCheckout ? (
              <>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    We couldn&apos;t locate your PayHere session. Return to checkout to try again.
                  </p>
                </div>
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {orderError ?? "PayHere reported a failed payment. Please try again."}
                  </p>
                </div>
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your payment is complete and the order is now in our system.
                  </p>
                </div>
                <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
